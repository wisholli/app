...
export const updateUserStatusTC = (status) => {return (dispatch) => {userProfileAPI.updateUserStatus(status).then((data) => {if(data.resultCode === 0) dispatch(setUserStatus(status))})}}
